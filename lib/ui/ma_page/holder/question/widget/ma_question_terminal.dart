...
class MaQuestionTerminal extends StatefulWidget {
  ...
  @override
  State<MaQuestionTerminal> createState() => _QuestionTerminalState();
}

class _QuestionTerminalState extends State<MaQuestionTerminal> {
  // 6. 터미널 높이 조절 로직
  ...
  void _onTerminalDragUpdate(DragUpdateDetails d) {
    ...
    setState(
      () => _terminalHeight = next.clamp(
        MaQuestionTerminal._terminalMin,
        _terminalMax,
      ),
    );
  }
