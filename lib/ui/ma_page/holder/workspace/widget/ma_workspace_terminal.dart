...
class MaWorkspaceTerminal extends StatefulWidget {
  @override
  State<MaWorkspaceTerminal> createState() => _MaWorkspaceTerminalState();
}

class _MaWorkspaceTerminalState extends State<MaWorkspaceTerminal> {
  @override
