...
import 'package:jjava_flutter/ui/ma_page/onboarding/widget/ma_onboarding_slide.dart';

class MaOnboardingBody extends StatefulWidget {
  const MaOnboardingBody({super.key});

  @override
  State<MaOnboardingBody> createState() => _MaOnboardingBodyState();
}

class _MaOnboardingBodyState extends State<MaOnboardingBody> {
  int _index = 0;
