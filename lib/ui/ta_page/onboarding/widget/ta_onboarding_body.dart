...
import 'package:jjava_flutter/ui/ta_page/onboarding/widget/ta_onboarding_slide.dart';

class TaOnboardingBody extends StatefulWidget {
  const TaOnboardingBody({super.key});

  @override
  State<TaOnboardingBody> createState() => _TaOnboardingBodyState();
}

class _TaOnboardingBodyState extends State<TaOnboardingBody> {
  int _index = 0;
