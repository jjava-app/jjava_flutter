...
class TaHomeQuickActions extends StatelessWidget {
  const TaHomeQuickActions({super.key});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => TaMainHolder(initialIndex: 1)),
        );
      },
      child: Container(
        width: 157,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => TaMainHolder(initialIndex: 2)),
        );
      },
      child: Container(
        width: 157,
