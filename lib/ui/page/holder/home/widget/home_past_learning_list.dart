...
class HomePastLearningList extends StatelessWidget {
  const HomePastLearningList({
    super.key,
  });
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          MText.bodyTiny('2025-08-07', color: MColor.kLabel.alternative),
        ],
      ),
    );
  }
