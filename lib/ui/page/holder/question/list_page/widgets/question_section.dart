...
class QuestionSection extends StatefulWidget {
  ...
  @override
  State<QuestionSection> createState() => _SectionTileState();
}

class _SectionTileState extends State<QuestionSection> {
            ...
            Column(
              children: [
                for (var i = 0; i < widget.section.problems.length; i++) ...[
                  InkWell(
                    onTap: () => widget.onProblemTap?.call(widget.section.problems[i]),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                      child: Row(
                        children: [
                          Expanded(child: Text(widget.section.problems[i].title)),
                  ...
                  if (i != widget.section.problems.length - 1) Divider(height: 1, thickness: 1, color: MColor.kPrimary.normal),
                ],
              ],
            ),
        ],
