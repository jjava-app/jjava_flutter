...
class _Bottom {
  final Widget solvedQuestion = SvgPicture.asset('assets/icons/nav_bottom_solved_question.svg');
  final Widget home = SvgPicture.asset('assets/icons/nav_bottom_home.svg');
  final Widget myPage = SvgPicture.asset('assets/icons/nav_bottom_my_page.svg');
  final Widget question = SvgPicture.asset('assets/icons/nav_bottom_question.svg');
  final Widget workspace = SvgPicture.asset('assets/icons/nav_bottom_workspace.svg');
}
