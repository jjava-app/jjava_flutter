<img width="168" height="224" alt="image" src="https://github.com/user-attachments/assets/834cb7b1-732a-4607-b7dc-10dcc1b36577" />

# 심화 프로젝트 1  OPEN AI를 활용한 Springboot 기반 개발앱 : 블록 코딩 앱

- Flutter로 개발한 블록 코딩 앱 짜바(JJAVA)입니다.
- 고난이도의 블록코딩을 통한 사용자의 코딩 능력 향상과 모바일/태블릿 기기를 통한 접근성 높은 서비스를 기대합니다.
...
| 카테고리         | 구현 기능                                         |
|--------------|-----------------------------------------------|
| **홈**        | 이번 주 랭킹 / 내 랭킹 / 지난 학습 보기               |
| **워크스페이스**     | 개인 워크스프에스 / 블록코딩 및 컴파일           |
| **학습** | 문제 목록 / 문제 풀기 / 문제 상세보기 / 문제 컴파일 및 AI 첨삭                |
| **지난 학습**     | 푼 문제 AI 첨삭 다시보기 / 푼 문제 AI 리팩토링 JAVA코드 다시보기 / 푼 문제 내용 및 제목 다시보기             |
| **로그인 인증**    | 앱 이메일 로그인 및 이메일 인증 구현 / 카카오 OAUTH 로그인 구현 / 구글 OAUTH 로그인 구현 / 네이버 OAUTH 로그인 구현 |
| **마이페이지**    | 내 정보 수정 / 카카오, 네이버, 구글 계정 연동                                      |
| **온보딩**   | 사용자 튜토리얼 화면                    |
...
|                                           김정원                                           |                                                           이연호                                                            |                                                       서회정                                                        |
|:---------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------:|
| <img width="150" height="150" alt="image" src="https://github.com/user-attachments/assets/4a561614-5101-4082-a159-b8b27f6e7744" alt="김정원"/> | <img width="150" height="150" alt="image" src="https://github.com/user-attachments/assets/dc250b8d-8da0-466b-826e-a295fe5632f3" alt="이연호"/> | <img src="https://github.com/human-mjj/recruit-wwy/blob/master/README/image.png?raw=true" alt="서회정" width="150"> |
|                                           PL                                            |                                                            FE                                                            |                                                        FE                                                        |
|                           [GitHub](https://github.com/hahamik)                           |                                           [GitHub](https://github.com/yh88888888)                                           |                                      [GitHub](https://github.com/clubnerdy)                                      |
